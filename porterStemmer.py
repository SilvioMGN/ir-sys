# taken from https://github.com/jedijulia/porter-stemmer
...
class PorterStemmer:
    ...
    def isConsonant(self, word, i):
        ...
        if self.isCons(letter):
            if letter == 'y' and self.isCons(word[i-1]): # added self keyword
                return False
            else:
                return True
        else:
    ...
    def isVowel(self, word, i):
        return not(self.isConsonant(word, i)) # added self keyword
